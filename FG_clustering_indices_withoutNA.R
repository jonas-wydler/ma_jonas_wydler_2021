...
load("famd_withoutNA.RData")
load("gow_withoutNA.RData")
...
grid.arrange(cbind(rbind(ggplotGrob(g1v2), ggplotGrob(g3v2)), rbind(ggplotGrob(g2v2), ggplotGrob(g4v2))), top=textGrob("Indices (Data without NA, n = 283)",gp=gpar(fontsize=14,font=3), just = "top"))
