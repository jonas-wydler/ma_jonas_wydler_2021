...
#wds with intermediate results saved
wd_dat <- ("/data/intermediate_results_from_projections/hsi/")
wd_fd <- ("/data/intermediate_results_from_projections/functional_diversity/")
wd_size <- ("/data/intermediate_results_from_projections/body_size/")
wd_sac <- ("/data/intermediate_results_from_projections/sac_spawning/")
wd_myel <- ("/data/intermediate_results_from_projections/myelination/")
wd_thropic <- ("/data/intermediate_results_from_projections/trophic_groups/")
wd_feeding <- ("/data/intermediate_results_from_projections/feeding_groups/")
wd_biomass <- ("/data/Zooplankton_biomass_COPEPOD/")
wd_clim <- ("/data/global_monthly_clims_1d/")

wd_script <- ("/data/") #where you want plots to go
