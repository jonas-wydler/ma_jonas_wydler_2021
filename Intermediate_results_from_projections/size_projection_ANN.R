...
# Replace ANN everywhere for GLM and GAM or use the provided scripts.
# -------------------------------------------------------------------------------------------------
...
ggsave(plot = g2, filename = paste0("Copepod_nmedian_size_n(mm)_map_annual_ANN_narmF.jpg"),dpi = 300, width = 7, height = 4)


setwd(wd_ensemble)
annual_size_ANN_naF <- med.size2
save(annual_size_ANN_naF,file = "annual_size_ANN_naF")
