...
res <- mclapply(files, function(f) {
  ...
  setwd(wd_script)
  ggsave(plot = g1, filename = paste0("FR_binary_ANN_",name_month,"_famd_ward_v2.jpg"),dpi = 300, width = 7, height = 4)
  ...
  # 
  # ggsave(plot = g2, filename = paste0("Quantiles_binary_famd_ward_",name_month,"_ANN_v2.jpg"),dpi = 300, width = 7, height = 4)
  save(df, file = paste0("dat_binary_ANN_", name_month,"_famd_ward_v2.Rda"))
...
#test <- res[[1]]
save(table_df, file = paste0("dat_faith_annual_ANN_binary_famd_ward_v2.Rda"))
...
#setwd(wd_maps)
ggsave(plot = g1, filename = paste0("FR_binary_annual_ANN_famd_ward_v2.jpg"),dpi = 300, width = 7, height = 4)
...
# 
# ggsave(plot = g4, filename = paste0("Quantiles_binary_annual_ANN_ward.jpg"),dpi = 300, width = 7, height = 4)
